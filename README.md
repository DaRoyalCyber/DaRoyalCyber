...
* Threat Detection: YARA, SIGMA, MITRE ATT&CK®, Splunk (SIEM), Microsoft Defender (EDR).
* Windows Internals: Kerberos, Windows API, ETW, WMI, KMDF (Kernel-Mode Drivers).
* Networking & Cloud: PfSense, Wireshark, AWS IAM, TailScale.
...
![Cybersecurity](https://img.shields.io/badge/Cyber_Security-red?style=for-the-badge&logo=eset&logoColor=white)
